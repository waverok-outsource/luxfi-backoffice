  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className="pointer-events-none block rounded-full ring-0 transition-transform group-data-[tone=default]/switch:data-checked:bg-primary-gold-light group-data-[tone=default]/switch:data-unchecked:bg-[#7E868D] group-data-[tone=success]/switch:data-checked:bg-[#0C5C22] group-data-[tone=success]/switch:data-unchecked:bg-[#727980] group-data-[tone=mono]/switch:bg-white group-data-[size=default]/switch:size-5 group-data-[size=sm]/switch:size-4 group-data-[size=default]/switch:data-unchecked:translate-x-[2px] group-data-[size=sm]/switch:data-unchecked:translate-x-[2px] group-data-[size=default]/switch:data-checked:translate-x-[calc(100%-2px)] group-data-[size=sm]/switch:data-checked:translate-x-[calc(100%-2px)]"
      />
    </SwitchPrimitive.Root>
  );
}
